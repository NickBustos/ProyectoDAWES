...
class BD
{
    ...
    public static function select($campos, $tabla, $where=[])
    {
    ...
    public static function realizarSql($conexion, $sql, $datos)
    {
        $preparedSttm = $conexion->prepare($sql);
...
// $bd->select(["*"], "usuario");
// BD::insertar("usuario", ["","","","","","","","","","","","",""]);
// BD::update("usuario", ["email"], ["pepe"], "id", 5);
BD::delete("usuario", "id", 5);
